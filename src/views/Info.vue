<template>
    <div class="bg-gray-100 w-full">
                    ...
                    <div class="sm:w-1/2 text-left sm:px-20">
                        <div class=" sm:text-left sm:w-[400px] w-full text-center px-5 sm:px-0">
                            ...
                            <p class=" text-base tracking-wide leading-10">共同奉献，所谓“人心齐，泰山移”。团队的含义
                                就在于有共同的价值观念。就如同一个人的价值观
                                念影响个人行为和思想一样，组织的价值观也就影
                                响团队的行为和思想。</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sm:w-1/2 text-left sm:px-20">
                        <div class=" sm:text-left sm:w-[400px] w-full text-center px-5 sm:px-0">
                            ...
                            <p class=" text-base tracking-wide leading-10">我们尊重自我个性的尽情展现，更崇尚集体智慧的
                                极致发挥，追求团队协作中互补共进、团体提升。
                                始终坚持团队的共同目标为根本，团结奋进，紧密
                                合作，集体的智慧产生超常的合力效应。</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sm:w-1/2 text-left ">
                        <div class=" sm:text-left sm:w-[400px] w-full text-center px-5 sm:px-0">
                            ...
                            <p class=" text-base tracking-wide leading-10">公会始终秉承共赢精神，意味着与社会各方保持着
                                ...
                                共同发展、利益共享，并倡导每位公会成员以道德
                                为基石，对己对彼立诚守信，优诺比践。</p>
                        </div>
                    </div>
                    <div class="sm:w-1/2 h-full w-full">
                        <img src="@/assets/3/2.png" alt="" class="w-full h-full">
                    </div>
                </div>
            </div>
        ...
        <div class="h-fit ">
            <img src="@/assets/3/6.png" alt="banner" class="w-full h-full" />
        </div>
        <div class="sm:py-20 w-full ">
            <div class="w-full bg-white py-14">
                <div class="container sm:px-16 px-5   mx-auto md:max-w-screen-md lg:max-w-screen-xl bg-HomecardBg">
                    <p class=" text-base tracking-wide leading-8 sm:leading-10">挚诚公会作为国内知名的互联网创业服务团队，我们坚持长期投资和风险分散化的投资理念，投资活动基于商业
                        目的，以研究和资产配置为驱动，旨在可接受风险范围内实现成员权益最大化，并不寻求通过投资控制行业或企
                        业。我们是负责任的投资者，严格遵守本国和投资接受国或地区的相关法律、法规，积极履行企业社会责任。我
                        们正直诚信、具备良好的职业操守和道德品质；认同团队文化，共同成长与发展；具备较强的业务能力和专业水
                        平；富有激情，勇于创新，敢于承担压力和挑战；善于沟通，乐于合作，具备较强的团队合作能力。</p>
                </div>
            </div>
        </div>
    </div>
